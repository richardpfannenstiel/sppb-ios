...
public class PoseOverlayHelper {
    ...
    private enum Constants {
        ...
        static let nearZColor = UIColor.red
        static let farZColor = UIColor.blue
        static let nearZFootColor = UIColor.yellow
        static let farZFootColor = UIColor.green
    }
    ...
    public static func createPoseOverlayView(
        ...
        for (startLandmarkType, endLandmarkTypesArray) in PoseOverlayHelper.poseConnections() {
            ...
            for endLandmarkType in endLandmarkTypesArray {
                ...
                if startLandmarkType.isFootLandmark && endLandmarkType.isFootLandmark {
                    startColor = PoseOverlayHelper.interpolatedColor(
                        fromColor: Constants.nearZFootColor, toColor: Constants.farZFootColor, ratio: landmarkZRatio)
                    endColor = PoseOverlayHelper.interpolatedColor(
                        fromColor: Constants.nearZFootColor, toColor: Constants.farZFootColor, ratio: connectedLandmarkZRatio)
                } else {
                    startColor = PoseOverlayHelper.interpolatedColor(
                        fromColor: Constants.nearZColor, toColor: Constants.farZColor, ratio: landmarkZRatio)
                    endColor = PoseOverlayHelper.interpolatedColor(
                        fromColor: Constants.nearZColor, toColor: Constants.farZColor, ratio: connectedLandmarkZRatio)
                }
                
                
                PoseOverlayHelper.addLineSegment(
    ...
    private static func addRectangle(_ rectangle: CGRect, to view: UIView, color: UIColor) {
    ...
    private static func addShape(withPoints points: [NSValue]?, to view: UIView, color: UIColor) {
